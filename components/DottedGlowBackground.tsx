  ...
  useEffect(() => {
    ...
    const draw = (now: number) => {
      ...
      dots.forEach((d) => {
        ...
        if (intensity > 0.7) {
           // Glow effect using standard arcs instead of expensive shadowBlur
           ...
           // Halo (simulated blur, >100x faster than shadowBlur)
           ctx.globalAlpha = opacity * (intensity - 0.7) * 1.5;
           ctx.beginPath();
